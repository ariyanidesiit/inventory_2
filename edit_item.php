...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = $conn->prepare("UPDATE barang SET nama_barang = ?, jumlah_barang = ?, harga_barang = ? WHERE id_barang = ?");
    $sql->bind_param("siis", $nama_barang, $jumlah_barang, $harga_barang, $id);
    ...
    <div id="wrapper">
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="tables.php">Tampilkan Data Barang</a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Manajemen Tambah Data Barang</h1>
        ...
        <form action="edit_item.php" method="post">
            ...
            <div class="form-group">
                ...
                <input type="number" class="form-control" id="harga_barang" name="harga_barang" value="<?php echo $row['harga_barang']; ?>" required>
            </div>
